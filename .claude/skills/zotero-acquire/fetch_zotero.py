...
Usage:
    python fetch_zotero.py --collection wiki
    python fetch_zotero.py --collection "State of AI" --dry-run
    python fetch_zotero.py -c wiki --limit 3 --json
...
def main() -> int:
    ...
    ap.add_argument("-c", "--collection", default="wiki", help="Zotero collection name (default: wiki)")
