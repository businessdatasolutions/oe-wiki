...
lines.push("")
lines.push(
  "Refer to [`CLAUDE.md`](../CLAUDE.md) for the full schema, [`llm-wiki.md`](../llm-wiki.md) for the system blueprint, and the most recent log entries for what's in flight.",
)
